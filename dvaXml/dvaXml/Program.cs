...
namespace xml
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            XDocument dokPrvi = XDocument.Parse(s1);
            XDocument dokDrugi = XDocument.Parse(s2);

            var rezultat1 = from xmlBooks1 in dokPrvi.Descendants("book")
                          from xmlBooks2 in dokDrugi.Descendants("book")
                          select new
                          {
                              book1 = new
                              {
            ...
            var rezultat2 = from i in rezultat1
